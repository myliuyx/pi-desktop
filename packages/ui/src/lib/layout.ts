...
/* ---------------------------------------------------------------------------
 * 目录选择弹窗（dir-picker 批次，「自定义路径…」的数据源弹窗）
 * ------------------------------------------------------------------------- */

/** 目录选择弹窗宽度（路径输入 + 子目录列表，略窄于设置弹窗） */
export const DIR_PICKER_WIDTH = 560;

/** 目录选择弹窗高度（恒定不随内容塌缩，与 SETTINGS_DIALOG_HEIGHT 同一条 ★ 纪律） */
export const DIR_PICKER_HEIGHT = 520;
